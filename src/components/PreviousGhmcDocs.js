...
// const PreviousGhmcDocs = ({ docsData, loc, process, type = "view" }) => {
//   console.log('PreviousGhmcDocs received:', { 
//     docsData, 
//     loc, 
//     process, 
//     type,
//     hasDocsData: !!docsData,
//     processName: docsData?.PROCESS
//   });
...
//   // NEW STATE: Track current plant/process to detect changes
...
//   // NEW: Clear deleted docs when plant/process changes
//   useEffect(() => {
//     if (loc !== currentContext.plant || process !== currentContext.process) {
//       console.log('Context changed, clearing deleted docs:', { 
//         oldPlant: currentContext.plant, 
//         newPlant: loc,
//         oldProcess: currentContext.process,
//         newProcess: process
//       });
...
//   // Don't render anything if no plant is selected or docsData is empty
//   if (!loc || !docsData || Object.keys(docsData).length === 0) {
//     return (
//       <Card className="p-3" style={{ height: '100%' }}>
//         <p className="text-muted text-center mb-0">
//           {!loc ? "Select a plant to view documents" : "No documents available"}
//         </p>
//       </Card>
//     );
//   }
...
//   const isModifyMode = type === "modify";
//   const isUpdated = docsData?.UPDATED?.toString() === "YES";
//   const canDelete = isModifyMode && !isUpdated;
...
//             return (
//               <ListGroup.Item
//                 key={`${currentContext.timestamp}-${docType}-${idx}`} // Add timestamp to key
//                 className="d-flex justify-content-between align-items-center"
//               >
//                 <div className="d-flex align-items-center">
//                   <BoxArrowUpRight className="me-3" color="royalblue" size={20} />
...
//         >
//           {logs.length > 0 ? `View Logs (${logs.length})` : 'No Logs'}
//         </Button>
//       </div>

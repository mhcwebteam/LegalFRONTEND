...
// const PreviousGhmcDocs = ({ docsData, onRefresh, loc, process }) => {
...
//       // Refresh the parent component data if callback provided
//       if (onRefresh) {
//         onRefresh();
//       }
...
//         {renderList(feas, "Feasibility Documents", "FEAS_DOCS")}
//         {renderList(amount, "Amount Paid Documents", "AMOUNT_DOCS")}

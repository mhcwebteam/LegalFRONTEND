...
const GhmcModify = () => {
  ...
  // Fetch all steps on mount
  useEffect(() => {
    axios
      .get(`${API_BASE_URLS}/GHMC-process`)
      .then((res) => {
        setSteps(res.data);
...
console.log("loc",loc);
  ...
  // Calculate next step based on completed processes
  useEffect(() => {
  ...
  // Update form when nextStepDetails changes
  useEffect(() => {
...
console.log("storeData",storeData);
    ...
    try {
      const existingRecord = storeData.find(
       ...
       console.log(existingRecord,"strpoeeeeeeee")
